            ...
            <div className="p-4">
              ...
              <div className="mb-6 space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center space-x-3 p-3 text-electric-300 hover:text-electric-200 hover:bg-electric-500/10 rounded-lg transition-colors group"
                >
                  ...
                  <span>Radar</span>
                  <span className="ml-auto text-xs px-2 py-0.5 rounded-full bg-electric-500/20 text-electric-300 group-hover:bg-electric-500/30">NEW</span>
                </button>
