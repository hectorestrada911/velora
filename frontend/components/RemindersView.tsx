            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-semibold text-white">Add New Reminder</h3>
                  <button
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleAddReminder(); }} className="space-y-4">
                  ...
                  <div className="flex space-x-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="flex-1 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 hover:scale-105"
                    >
                      Add Reminder
                    </button>
                  </div>
