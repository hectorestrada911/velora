        ...
        >
          ...
          <div className="max-w-6xl mx-auto px-4 relative z-10">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.4 }}
              className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-8 lg:gap-12 mb-1 md:mb-20 px-0"
            >
              {/* Card 1: Wasting Time */}
              <motion.div
                whileHover={{ 
              ...
              >
                ...
                <div className="relative z-10 p-0 md:p-8 lg:p-10 text-center">
                  <motion.div
                    animate={{ 
                      rotate: [0, 15, -15, 0],
                      scale: [1, 1.1, 1]
                    ...
                    transition={{ duration: 4, repeat: Infinity }}
                    className="w-4 h-4 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-r from-red-500 via-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 lg:mb-8 shadow-2xl relative"
                  >
                    <motion.div
                    ...
                    />
                    <Clock className="w-2 h-2 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white relative z-10" />
                  </motion.div>
                  
                  <motion.h4 
                    whileHover={{ scale: 1.05, x: 5 }}
                    className="text-white font-black text-xs md:text-xl lg:text-2xl mb-0 md:mb-4 lg:mb-6"
                  >
              ...
              >
                ...
                <div className="relative z-10 p-0 md:p-8 lg:p-10 text-center">
                  <motion.div
                    ...
                    transition={{ duration: 3, repeat: Infinity }}
                    className="w-4 h-4 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 lg:mb-8 shadow-2xl relative"
                  >
                    <motion.div
                    ...
                    />
                    <Target className="w-2 h-2 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white relative z-10" />
                  </motion.div>
              ...
              >
                ...
                <div className="relative z-10 p-0 md:p-8 lg:p-10 text-center">
                  <motion.div
                    ...
                    transition={{ duration: 2, repeat: Infinity }}
                    className="w-4 h-4 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 lg:mb-8 shadow-2xl relative"
                  >
                    <motion.div
                    ...
                    />
                    <Brain className="w-2 h-2 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white relative z-10" />
                  </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-8 lg:gap-12 max-w-6xl mx-auto">
                <motion.div
                  whileHover={{ 
                    scale: 1.1, 
                    y: -15,
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-gray-900/40 to-gray-800/20 rounded-3xl p-0 md:p-8 border border-electric-500/30 backdrop-blur-sm">
                    <motion.div
                      animate={{ rotate: [0, 360] }}
                      transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                      className="w-4 h-4 md:w-20 md:h-20 bg-gradient-to-r from-electric-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 shadow-2xl"
                    >
                      <MessageSquare className="w-2 h-2 md:w-10 md:h-10 text-white" />
                    </motion.div>
                    <h5 className="text-white font-bold text-xs md:text-xl mb-0 md:mb-3">Ask Anything</h5>
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-gray-900/40 to-gray-800/20 rounded-3xl p-0 md:p-8 border border-purple-500/30 backdrop-blur-sm">
                    <motion.div
                      animate={{ scale: [1, 1.2, 1] }}
                      transition={{ duration: 2, repeat: Infinity }}
                      className="w-4 h-4 md:w-20 md:h-20 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 shadow-2xl"
                    >
                      <Calendar className="w-2 h-2 md:w-10 md:h-10 text-white" />
                    </motion.div>
                    <h5 className="text-white font-bold text-xs md:text-xl mb-0 md:mb-3">Never Miss Deadlines</h5>
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-gray-900/40 to-gray-800/20 rounded-3xl p-0 md:p-8 border border-cyan-500/30 backdrop-blur-sm">
                    <motion.div
                      animate={{ opacity: [0.7, 1, 0.7] }}
                      transition={{ duration: 3, repeat: Infinity }}
                      className="w-4 h-4 md:w-20 md:h-20 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-0 md:mb-6 shadow-2xl"
                    >
                      <Brain className="w-2 h-2 md:w-10 md:h-10 text-white" />
                    </motion.div>
                    <h5 className="text-white font-bold text-xs md:text-xl mb-0 md:mb-3">Learns Your Patterns</h5>
